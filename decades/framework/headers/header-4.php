<header  id="<?php if(decades_get_option('header_trans')) echo 'header-home-2';else echo 'stick'; ?>" class="header-4 <?php if(decades_get_option('header_trans')) echo 'bg-transparent fixed'; ?>">
	<h1  class="logo">
