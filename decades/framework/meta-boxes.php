...
function decades_register_meta_boxes( $meta_boxes ) {
	...
	$meta_boxes[] = array(
		...
		'title'    => esc_html__( 'Format Details', 'decades' ),
		...
		'fields'   => array(
			...
			array(
				...
				'name'  => esc_html__( 'Gallery', 'decades' ),
...
add_filter( 'rwmb_meta_boxes', 'decades_register_meta_boxes' );
