...
$disable_element = $fullwidth = $fullheight = $parallax_bg = $particles = '';
$output = $after_output = '';
...
if ($particles) {
$output .= '<section ' . implode( ' ', $wrapper_attributes ) . $attr . ' ><div id="particles" class="particle-bg"></div>';
}else{	
$output .= '<section ' . implode( ' ', $wrapper_attributes ) . $attr . ' >';
}
if ($fullwidth == 'no') {
